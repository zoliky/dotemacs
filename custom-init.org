           ...
           (make-mu4e-context
            ...
            :vars '((user-mail-address  . "zoliky@gmail.com")
                    ...
                    (mu4e-maildir-shortcuts
                     . (("/zoliky-gmail/INBOX"              . ?i)
                        ("/zoliky-gmail/[zoliky].Sent Mail" . ?s)
                        ("/zoliky-gmail/[zoliky].Trash"     . ?t)
                        ("/zoliky-gmail/[zoliky].All Mail"  . ?a)
                        ("/zoliky-gmail/[zoliky].Starred"   . ?r)
                        ("/zoliky-gmail/[zoliky].Drafts"    . ?d)))))
           (make-mu4e-context
            ;; Work context
            :name "work"
            ...
            :vars '((user-mail-address  . "zolikydev@gmail.com")
                    ...
                    (mu4e-maildir-shortcuts
                     . (("/zolikydev-gmail/INBOX"                 . ?i)
                        ("/zolikydev-gmail/[zolikydev].Sent Mail" . ?s)
                        ("/zolikydev-gmail/[zolikydev].Trash"     . ?t)
                        ("/zolikydev-gmail/[zolikydev].All Mail"  . ?a)
                        ("/zolikydev-gmail/[zolikydev].Starred"   . ?r)
                        ("/zolikydev-gmail/[zolikydev].Drafts"    . ?d))))))))
