...
#+begin_src emacs-lisp
  ...
  (dolist (char (string-to-list "æθðŋˈˌ"))
          ...
          (list
           (make-mu4e-context
            ...
            :vars '((user-mail-address  . "zoliky@gmail.com")
                    ...
                    (mu4e-sent-folder   . "/zoliky-gmail/[zoliky].Sent Mail")
                    (mu4e-drafts-folder . "/zoliky-gmail/[zoliky].Drafts")
                    (mu4e-trash-folder  . "/zoliky-gmail/[zoliky].Trash")
                    (smtpmail-queue-dir . "~/Maildir/zoliky-gmail/queue/cur")
                    (smtpmail-smtp-user . "zoliky")
                    (mu4e-maildir-shortcuts
                     . ((:maildir "/zoliky-gmail/INBOX"              :key ?i)
                        (:maildir "/zoliky-gmail/[zoliky].Sent Mail" :key ?s)
                        (:maildir "/zoliky-gmail/[zoliky].Trash"     :key ?t)
                        (:maildir "/zoliky-gmail/[zoliky].All Mail"  :key ?a)
                        (:maildir "/zoliky-gmail/[zoliky].Starred"   :key ?r)
                        (:maildir "/zoliky-gmail/[zoliky].Drafts"    :key ?d)))))
           (make-mu4e-context
            ;; Work context
            :name "work"
            ...
            :vars '((user-mail-address  . "zolikydev@gmail.com")
                    (user-full-name     . "Zoltan Kiraly")
                    (mu4e-sent-folder   . "/zolikydev-gmail/[zolikydev].Sent Mail")
                    (mu4e-drafts-folder . "/zolikydev-gmail/[zolikydev].Drafts")
                    (mu4e-trash-folder  . "/zolikydev-gmail/[zolikydev].Trash")
                    (smtpmail-queue-dir . "~/Maildir/zolikydev-gmail/queue/cur")
                    (smtpmail-smtp-user . "zolikydev")
                    (mu4e-maildir-shortcuts
                     . ((:maildir "/zolikydev-gmail/INBOX"                 :key ?i)
                        (:maildir "/zolikydev-gmail/[zolikydev].Sent Mail" :key ?s)
                        (:maildir "/zolikydev-gmail/[zolikydev].Trash"     :key ?t)
                        (:maildir "/zolikydev-gmail/[zolikydev].All Mail"  :key ?a)
                        (:maildir "/zolikydev-gmail/[zolikydev].Starred"   :key ?r)
                        (:maildir "/zolikydev-gmail/[zolikydev].Drafts"    :key ?d))))))))
...
#+begin_src emacs-lisp
  (use-package org-crypt
    ...
    :custom
    ;; Public key
    (org-crypt-key "99F8A29B4A23A8DE4286A4FB1AE00C0C67F269F3")
    :config
...
A flashcards and spaced repetition system for Org mode.
